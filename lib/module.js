var ogl = (function (t) {
    ...
    class g {
            ...
            this.gl.renderer.currentGeometry !== `${this.id}_${t.attributeOrder}` &&
                ...
                this.isInstanced
                    ? this.attributes.index
                        ? this.gl.renderer.drawElementsInstanced(e, this.drawRange.count, this.attributes.index.type, this.drawRange.start, this.instancedCount)
                        : this.gl.renderer.drawArraysInstanced(e, this.drawRange.start, this.drawRange.count, this.instancedCount)
                    : this.attributes.index
                    ? this.gl.drawElements(e, this.drawRange.count, this.attributes.index.type, this.drawRange.start)
        ...
        computeBoundingBox(t) {
            !t && this.attributes.position && (t = this.attributes.position.data),
                ...
                this.bounds || (this.bounds = { min: new l(), max: new l(), center: new l(), scale: new l(), radius: 1 / 0 });
        ...
        use({ flipFaces: t = !1 } = {}) {
            ...
            this.gl.renderer.currentProgram === this.id || (this.gl.useProgram(this.program), (this.gl.renderer.currentProgram = this.id)),
                this.uniformLocations.forEach((t, i) => {
                    let r = i.uniformName,
                        s = this.uniforms[r];
                    if ((i.isStruct && ((s = s[i.structProperty]), (r += `.${i.structProperty}`)), i.isStructArray && ((s = s[i.structIndex][i.structProperty]), (r += `[${i.structIndex}].${i.structProperty}`)), !s))
        ...
        fromMatrix3(t) {
            return (
                (function (t, e) {
                    let i,
                        r = e[0] + e[4] + e[8];
                    if (r > 0) (i = Math.sqrt(r + 1)), (t[3] = 0.5 * i), (i = 0.5 / i), (t[0] = (e[5] - e[7]) * i), (t[1] = (e[6] - e[2]) * i), (t[2] = (e[1] - e[3]) * i);
                    else {
                        let r = 0;
            ...
            return (
                (function (t, e, i = "YXZ") {
                    let r = Math.sin(0.5 * e[0]),
                        ...
                        o = Math.cos(0.5 * e[2]);
                    "XYZ" === i
                        ? ((t[0] = r * a * o + s * n * h), (t[1] = s * n * o - r * a * h), (t[2] = s * a * h + r * n * o), (t[3] = s * a * o - r * n * h))
                        : "YXZ" === i
                        ? ((t[0] = r * a * o + s * n * h), (t[1] = s * n * o - r * a * h), (t[2] = s * a * h - r * n * o), (t[3] = s * a * o + r * n * h))
                        : "ZXY" === i
                        ? ((t[0] = r * a * o - s * n * h), (t[1] = s * n * o + r * a * h), (t[2] = s * a * h + r * n * o), (t[3] = s * a * o - r * n * h))
                        ...
                        : "YZX" === i
                        ? ((t[0] = r * a * o + s * n * h), (t[1] = s * n * o + r * a * h), (t[2] = s * a * h - r * n * o), (t[3] = s * a * o - r * n * h))
                        : "XZY" === i && ((t[0] = r * a * o - s * n * h), (t[1] = s * n * o - r * a * h), (t[2] = s * a * h + r * n * o), (t[3] = s * a * o + r * n * h));
                })(this, t, t.order),
                this
            );
        }
            ...
            return (
                (function (t, e, i, r) {
                    let s,
                        ...
                        m = i[2],
                        f = i[3];
                    (n = l * g + u * p + c * m + d * f) < 0 && ((n = -n), (g = -g), (p = -p), (m = -m), (f = -f)),
                        1 - n > 1e-6 ? ((s = Math.acos(n)), (a = Math.sin(s)), (h = Math.sin((1 - r) * s) / a), (o = Math.sin(r * s) / a)) : ((h = 1 - r), (o = r)),
                        (t[0] = h * l + o * g),
                        (t[1] = h * u + o * p),
                        (t[2] = h * c + o * m),
                        (t[3] = h * d + o * f);
            ...
            return (
                (function (t, e, i) {
                    let r,
                        ...
                        x = i[2];
                    e === t
                        ? ((t[12] = e[0] * m + e[4] * f + e[8] * x + e[12]), (t[13] = e[1] * m + e[5] * f + e[9] * x + e[13]), (t[14] = e[2] * m + e[6] * f + e[10] * x + e[14]), (t[15] = e[3] * m + e[7] * f + e[11] * x + e[15]))
                        : ((r = e[0]),
                          (s = e[1]),
                          (n = e[2]),
                          (a = e[3]),
            ...
            return (
                (function (t, e) {
                    let i = e[0] + e[5] + e[10],
                        r = 0;
                    i > 0
                        ? ((r = 2 * Math.sqrt(i + 1)), (t[3] = 0.25 * r), (t[0] = (e[6] - e[9]) / r), (t[1] = (e[8] - e[2]) / r), (t[2] = (e[1] - e[4]) / r))
                        : e[0] > e[5] && e[0] > e[10]
                        ? ((r = 2 * Math.sqrt(1 + e[0] - e[5] - e[10])), (t[3] = (e[6] - e[9]) / r), (t[0] = 0.25 * r), (t[1] = (e[1] + e[4]) / r), (t[2] = (e[8] + e[2]) / r))
                        : e[5] > e[10]
                        ? ((r = 2 * Math.sqrt(1 + e[5] - e[0] - e[10])), (t[3] = (e[8] - e[2]) / r), (t[0] = (e[1] + e[4]) / r), (t[1] = 0.25 * r), (t[2] = (e[6] + e[9]) / r))
                        : ((r = 2 * Math.sqrt(1 + e[10] - e[0] - e[5])), (t[3] = (e[1] - e[4]) / r), (t[0] = (e[8] + e[2]) / r), (t[1] = (e[6] + e[9]) / r), (t[2] = 0.25 * r));
                })(t, this),
                this
            );
        }
            ...
            return (
                (function (t, e, i, r) {
                    ...
                    let p = o * d - l * c,
                        m = l * u - h * d,
                        f = h * c - o * u;
                    (g = p * p + m * m + f * f) > 0 && ((p *= g = 1 / Math.sqrt(g)), (m *= g), (f *= g)),
                        (t[0] = p),
                        (t[1] = m),
                        (t[2] = f),
                        (t[3] = 0),
    ...
    class Y extends C {
        ...
        draw({ camera: t } = {}) {
            ...
            this.program.use({ flipFaces: e }), this.geometry.draw({ mode: this.mode, program: this.program }), this.onAfterRender && this.onAfterRender({ mesh: this, camera: t });
        }
    }
    ...
    class W {
        ...
        update(t = 0) {
            ...
            (e || this.glState.textureUnits[t] !== this.id) && (this.gl.renderer.activeTexture(t), this.bind()),
                e &&
                    ((this.needsUpdate = !1),
                    ...
                    this.image
                        ...
                        : this.gl.texImage2D(this.target, 0, this.gl.RGBA, 1, 1, 0, this.gl.RGBA, this.gl.UNSIGNED_BYTE, k),
    ...
    class j {
        constructor(
            ...
            for (let r = 0; r < s; r++)
                this.textures.push(new W(t, { width: e, height: i, wrapS: o, wrapT: l, minFilter: u, magFilter: c, type: d, format: g, internalFormat: p, unpackAlignment: m, premultiplyAlpha: f, flipY: !1, generateMipmaps: !1 })),
    ...
    class J extends Array {
        ...
        squaredDistance(t) {
            return t
                ? ((e = this), (r = (i = t)[0] - e[0]), (s = i[1] - e[1]), r * r + s * s)
                : (function (t) {
                      var e = t[0],
                          i = t[1];
                      return e * e + i * i;
    ...
    class tt extends g {
        constructor(t, { width: e = 1, height: i = 1, widthSegments: r = 1, heightSegments: s = 1, attributes: n = {} } = {}) {
            ...
            tt.buildPlane(u, c, d, g, e, i, 0, a, h), Object.assign(n, { position: { size: 3, data: u }, normal: { size: 3, data: c }, uv: { size: 2, data: d }, index: { data: g } }), super(t, n);
        }
        static buildPlane(t, e, i, r, s, n, a, h, o, l = 0, u = 1, c = 2, d = 1, g = -1, p = 0, m = 0) {
            ...
            for (let b = 0; b <= o; b++) {
                ...
                for (let n = 0; n <= h; n++, p++) {
                    let w = n * x - s / 2;
                    if (((t[3 * p + l] = w * d), (t[3 * p + u] = M * g), (t[3 * p + c] = a / 2), (e[3 * p + l] = 0), (e[3 * p + u] = 0), (e[3 * p + c] = a >= 0 ? 1 : -1), (i[2 * p] = n / h), (i[2 * p + 1] = 1 - b / o), b === o || n === h))
                        continue;
                    let v = f + n + b * (h + 1),
                        A = f + n + (b + 1) * (h + 1),
                        E = f + n + (b + 1) * (h + 1) + 1,
    ...
    return (
        ...
        (t.Box = class extends g {
            constructor(t, { width: e = 1, height: i = 1, depth: r = 1, widthSegments: s = 1, heightSegments: n = 1, depthSegments: a = 1, attributes: h = {} } = {}) {
                ...
                tt.buildPlane(g, p, m, f, r, i, e, u, l, 2, 1, 0, -1, -1, x, w),
                    tt.buildPlane(g, p, m, f, r, i, -e, u, l, 2, 1, 0, 1, -1, (x += (u + 1) * (l + 1)), (w += u * l)),
                    tt.buildPlane(g, p, m, f, e, r, i, u, l, 0, 2, 1, 1, 1, (x += (u + 1) * (l + 1)), (w += u * l)),
                    tt.buildPlane(g, p, m, f, e, r, -i, u, l, 0, 2, 1, 1, -1, (x += (o + 1) * (u + 1)), (w += o * u)),
                    tt.buildPlane(g, p, m, f, e, i, -r, o, l, 0, 1, 2, -1, -1, (x += (o + 1) * (u + 1)), (w += o * u)),
                    tt.buildPlane(g, p, m, f, e, i, r, o, l, 0, 1, 2, 1, -1, (x += (o + 1) * (l + 1)), (w += o * l)),
                    Object.assign(h, { position: { size: 3, data: g }, normal: { size: 3, data: p }, uv: { size: 2, data: m }, index: { data: f } }),
                    super(t, h);
            }
        }),
        (t.Camera = class extends C {
            constructor(t, { near: e = 0.1, far: i = 100, fov: r = 45, aspect: s = 1, left: n, right: a, bottom: h, top: o } = {}) {
                super(t),
                    (this.near = e),
                    (this.far = i),
                    (this.fov = r),
                    ...
                    n || a ? this.orthographic({ left: n, right: a, bottom: h, top: o }) : this.perspective();
            }
            perspective({ near: t = this.near, far: e = this.far, fov: i = this.fov, aspect: r = this.aspect } = {}) {
                return this.projectionMatrix.fromPerspective({ fov: i * (Math.PI / 180), aspect: r, near: t, far: e }), (this.type = "perspective"), this;
            }
            orthographic({ near: t = this.near, far: e = this.far, left: i = -1, right: r = 1, bottom: s = -1, top: n = 1 } = {}) {
                return this.projectionMatrix.fromOrthogonal({ left: i, right: r, bottom: s, top: n, near: t, far: e }), (this.type = "orthographic"), this;
            }
            updateMatrixWorld() {
        ...
        (t.Cylinder = class extends g {
            constructor(t, { radius: e = 0.5, height: i = 1, radialSegments: r = 16, heightSegments: s = 1, attributes: n = {} } = {}) {
                const a = r,
                    h = s,
                    o = (r + 1) * (s + 1) + 2,
                    u = r * (2 + 2 * s) * 3,
                ...
                let m,
                    ...
                    w = 0,
                    b = new l();
                (m = 0), (f = -0.5 * i), (x = 0), (c[3 * w + 0] = m), (c[3 * w + 1] = f), (c[3 * w + 2] = x), b.set(m, f, x).normalize(), (d[3 * w] = b.x), (d[3 * w + 1] = b.y), (d[3 * w + 2] = b.z), (g[2 * w] = 0), (g[2 * w + 1] = 1);
                let M = w;
                (m = 0), (f = 0.5 * i), (x = 0), (c[3 * ++w + 0] = m), (c[3 * w + 1] = f), (c[3 * w + 2] = x), b.set(m, f, x).normalize(), (d[3 * w] = b.x), (d[3 * w + 1] = b.y), (d[3 * w + 2] = b.z), (g[2 * w] = 0), (g[2 * w + 1] = 0);
                let v = w;
                w++;
                for (var A = 0; A < a + 1; A++) {
                    let t = A / a;
                ...
                for (A = 0; A < a; A++) {
                    let t = A + 1;
                    for (p[3 * y + 0] = M, p[3 * y + 1] = 2 + A * F, p[3 * y + 2] = 2 + t * F, y++, E = 0; E < h; E++)
                        (p[3 * y + 0] = 2 + A * F + (E + 0)),
                            (p[3 * y + 1] = 2 + A * F + (E + 1)),
                            (p[3 * y + 2] = 2 + t * F + (E + 0)),
                            (p[3 * ++y + 0] = 2 + t * F + (E + 0)),
                ...
                Object.assign(n, { position: { size: 3, data: c }, normal: { size: 3, data: d }, uv: { size: 2, data: g }, index: { data: p } }), super(t, n);
            }
        }),
        (t.Euler = B),
        (t.Flowmap = class {
            constructor(t, { size: e = 512, falloff: i = 0.3, alpha: r = 1, dissipation: s = 0.96 } = {}) {
                const n = this;
                (this.gl = t),
                    ...
                    (this.velocity = new J()),
                    (this.mesh = new Y(t, {
                        geometry: new g(t, { position: { size: 2, data: new Float32Array([-1, -1, 3, -1, -1, 3]) }, uv: { size: 2, data: new Float32Array([0, 0, 2, 0, 0, 2]) } }),
                        program: new f(t, {
                            vertex: vt,
                            fragment: At,
                            uniforms: { tMap: n.uniform, uFalloff: { value: 0.5 * i }, uAlpha: { value: r }, uDissipation: { value: s }, uAspect: { value: 1 }, uMouse: { value: n.mouse }, uVelocity: { value: n.velocity } },
                            depthTest: !1,
                        }),
                    }));
            }
            update() {
                (this.mesh.program.uniforms.uAspect.value = this.aspect), this.gl.renderer.render({ scene: this.mesh, target: this.mask.write, clear: !1 }), this.mask.swap();
            }
        }),
        (t.GPGPU = class {
            constructor(t, { data: e = new Float32Array(16), geometry: i = new g(t, { position: { size: 2, data: new Float32Array([-1, -1, 3, -1, -1, 3]) }, uv: { size: 2, data: new Float32Array([0, 0, 2, 0, 0, 2]) } }) }) {
                this.gl = t;
                const r = e;
                (this.passes = []),
                    (this.geometry = i),
            ...
            addPass({ vertex: t = Et, fragment: e = yt, uniforms: i = {}, textureUniform: r = "tMap", enabled: s = !0 } = {}) {
                i[r] = this.uniform;
                const n = new f(this.gl, { vertex: t, fragment: e, uniforms: i }),
                    a = { mesh: new Y(this.gl, { geometry: this.geometry, program: n }), program: n, uniforms: i, enabled: s, textureUniform: r };
            ...
            E.copy(t.position).sub(this.target),
                ...
                (this.update = () => {
                    (M.radius *= b.radius),
                        ...
                        (M.radius = Math.max(this.minDistance, Math.min(this.maxDistance, M.radius))),
                        (v.phi += (M.phi - v.phi) * s),
        ...
        (t.Post = class {
            constructor(
                t,
                {
                    ...
                    geometry: o = new g(t, { position: { size: 2, data: new Float32Array([-1, -1, 3, -1, -1, 3]) }, uv: { size: 2, data: new Float32Array([0, 0, 2, 0, 0, 2]) } }),
                } = {}
            ) {
                (this.gl = t), (this.options = { wrapS: s, wrapT: n, minFilter: a, magFilter: h }), (this.passes = []), (this.geometry = o);
                const l = (this.fbo = {
                    read: null,
                    write: null,
                    swap: () => {
            ...
            addPass({ vertex: t = lt, fragment: e = ut, uniforms: i = {}, textureUniform: r = "tMap", enabled: s = !0 } = {}) {
            ...
            render({ scene: t, camera: e, target: i = null, update: r = !0, sort: s = !0, frustumCull: n = !0 }) {
                ...
                this.gl.renderer.render({ scene: t, camera: e, target: a.length ? this.fbo.write : i, update: r, sort: s, frustumCull: n }),
                    this.fbo.swap(),
                    a.forEach((t, e) => {
                        (t.mesh.program.uniforms[t.textureUniform].value = this.fbo.read.texture), this.gl.renderer.render({ scene: t.mesh, target: e === a.length - 1 ? i : this.fbo.write, clear: !1 }), this.fbo.swap();
                    });
            }
        }),
        (t.Program = f),
        ...
        (t.Raycast = class {
            ...
            castMouse(t, e = [0, 0]) {
                t.worldMatrix.getTranslation(this.origin), this.direction.set(e[0], e[1], 0.5), t.unproject(this.direction), this.direction.sub(this.origin).normalize();
            }
            intersectBounds(t) {
                Array.isArray(t) || (t = [t]);
                const e = ot,
                ...
                return (
                    t.forEach((t) => {
                        ...
                        let n = 0;
                        (n = "sphere" === t.geometry.raycast ? this.intersectSphere(t.geometry.bounds, i, r) : this.intersectBox(t.geometry.bounds, i, r)) &&
                            (t.hit || (t.hit = { localPoint: new l() }), (t.hit.distance = n), t.hit.localPoint.copy(r).multiply(n).add(i), s.push(t));
                    }),
            ...
            intersectBox(t, e = this.origin, i = this.direction) {
                ...
                return (
                    ...
                    r > (a = ((u >= 0 ? g.y : d.y) - e.y) * u) || n > s
                        ? 0
                        : (n > r && (r = n), a < s && (s = a), (h = ((c >= 0 ? d.z : g.z) - e.z) * c), r > (o = ((c >= 0 ? g.z : d.z) - e.z) * c) || h > s ? 0 : (h > r && (r = h), o < s && (s = o), s < 0 ? 0 : r >= 0 ? r : s))
                );
            }
        }),
        (t.RenderTarget = j),
        (t.Renderer = class {
            constructor({
                ...
                const g = { alpha: s, depth: n, stencil: a, antialias: h, premultipliedAlpha: o, preserveDrawingBuffer: l, powerPreference: u };
                (this.dpr = r),
                    (this.alpha = s),
                    (this.color = !0),
                    (this.depth = n),
            ...
            setBlendFunc(t, e, i, r) {
                (this.state.blendFunc.src === t && this.state.blendFunc.dst === e && this.state.blendFunc.srcAlpha === i && this.state.blendFunc.dstAlpha === r) ||
                    ((this.state.blendFunc.src = t), (this.state.blendFunc.dst = e), (this.state.blendFunc.srcAlpha = i), (this.state.blendFunc.dstAlpha = r), void 0 !== i ? this.gl.blendFuncSeparate(t, e, i, r) : this.gl.blendFunc(t, e));
            }
            setBlendEquation(t, e) {
            ...
            getRenderList({ scene: t, camera: e, frustumCull: i, sort: r }) {
                ...
                if (
                    ...
                    const t = [],
                        ...
                        r = [];
                    s.forEach((s) => {
                        s.program.transparent ? (s.program.depthTest ? i.push(s) : r.push(s)) : t.push(s),
                            (s.zDepth = 0),
                            0 === s.renderOrder && s.program.depthTest && e && (s.worldMatrix.getTranslation(v), v.applyMatrix4(e.projectionViewMatrix), (s.zDepth = v.z));
                    }),
            ...
            render({ scene: t, camera: e, target: i = null, update: r = !0, sort: s = !0, frustumCull: n = !0, clear: a }) {
                null === i ? (this.bindFramebuffer(), this.setViewport(this.width * this.dpr, this.height * this.dpr)) : (this.bindFramebuffer(i), this.setViewport(i.width, i.height)),
                    ...
                    this.getRenderList({ scene: t, camera: e, frustumCull: n, sort: s }).forEach((t) => {
                        t.draw({ camera: e });
                    });
            }
        }),
        (t.Skin = class extends Y {
            constructor(t, { rig: e, geometry: i, program: r, mode: s = t.TRIANGLES } = {}) {
                super(t, { geometry: i, program: r, mode: s }),
                    ...
                    (this.animations = []),
                    Object.assign(this.program.uniforms, { boneTexture: { value: this.boneTexture }, boneTextureSize: { value: this.boneTextureSize } });
            }
            createBones(t) {
            ...
            createBoneTexture() {
                ...
                (this.boneMatrices = new Float32Array(t * t * 4)),
                    ...
                    (this.boneTexture = new W(this.gl, { image: this.boneMatrices, generateMipmaps: !1, type: this.gl.FLOAT, internalFormat: this.gl.renderer.isWebgl2 ? this.gl.RGBA16F : this.gl.RGBA, flipY: !1, width: t }));
            }
            addAnimation(t) {
        ...
        (t.Sphere = class extends g {
            constructor(t, { radius: e = 0.5, widthSegments: i = 16, heightSegments: r = Math.ceil(0.5 * i), phiStart: s = 0, phiLength: n = 2 * Math.PI, thetaStart: a = 0, thetaLength: h = Math.PI, attributes: o = {} } = {}) {
                const u = i,
                    c = r,
                    d = s,
                    g = n,
                ...
                Object.assign(o, { position: { size: 3, data: w }, normal: { size: 3, data: b }, uv: { size: 2, data: M }, index: { data: v } }), super(t, o);
            }
        }),
        (t.Text = function ({ font: t, text: e, width: i = 1 / 0, align: r = "left", size: s = 1, letterSpacing: n = 0, lineHeight: a = 1.4, wordSpacing: h = 0, wordBreak: o = !1 }) {
            const l = this;
            let u, c, d, g, p;
            const m = /\n/,
                f = /\s/;
            function x() {
                ...
                let i = e.replace(/[ \n]/g, "").length;
                c = { position: new Float32Array(4 * i * 3), uv: new Float32Array(4 * i * 2), id: new Float32Array(4 * i), index: new Uint16Array(6 * i) };
                    ...
                    (function (e) {
                        ...
                        for (let t = 0; t < e.length; t++) {
                            ...
                            for (let t = 0; t < l.glyphs.length; t++) {
                                ...
                                let s = l.glyphs[t][1];
                                if (("center" === r ? (s -= 0.5 * l.width) : "right" === r && (s -= l.width), f.test(e.char))) continue;
