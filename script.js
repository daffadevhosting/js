...
$(document).ready(function () {
    var dev = 'QXMtU3lhcmlhaCBCb3JkaXI=',
    myLicense = atob(dev),
    tpllc = $('#footer').text(),
    second = 20;
    ...
    $('body').append('<style>body{background:#000000b3!important;overflow:hidden}#peringatan span{font-size:50px}#peringatan{z-index:0;position:fixed;top:0;right:0;left:0;padding:16% 0;height:100%;text-align:center;background:#000000b3;color:#fff}@media only screen and (max-width: 680px){#peringatan{padding:60% 0;}h4{font-size:x-large!important;}}</style><div id="peringatan"><h4 style="margin-bottom: 35px;font-size:-webkit-xxx-large;">🔒️ Template is Locked Up</h4><span id="aktivasi">'+second+'</span><p style="margin-top: 20px;font-size: 18px;letter-spacing: 2px;line-height: 30px;">Mohon untuk tidak menghapus link footer</p></div>');
...
fixedMenu = 'undefined' == typeof fixedMenu || fixedMenu, $('#blogger-unang-main-nav').menublog(), $('#blogger-unang-main-nav .widget').addClass('show-menu'), $('.show-search').on('click', function () {
    ...
    $('.entry-image-wrap .entry-thumb,.author-avatar-wrap .author-avatar').lazyify(), $('#blogger-unang-mobile-menu').each(function () {
        ...
        _0x6179x3.attr('href', 'https://as-syariahbordir.github.io/').text('As-Syariah Bordir').attr('style', 'visibility:visible!important;opacity:1!important;position:relative!important;z-index:1!important;font-size:14px!important;color:var(--main-color)!important;margin:0!important;'), _0x6179x3.parent().attr('style', _0x6179x4).parent().attr('style', _0x6179x4)
    }), setInterval(function () {
